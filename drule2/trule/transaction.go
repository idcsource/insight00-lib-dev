...
func (t *Transaction) DeleteContextBind(area, id, contextname string, upordown uint8, bindrole string) (err error) {
	if t.be_delete == true {
...
func (t *Transaction) ReadContextSameBind(area, id, contextname string, upordown uint8, bind int64) (rolesid []string, have bool, err error) {
	if t.be_delete == true {
...
func (t *Transaction) WriteContextStatus(area, id, contextname string, upordown uint8, bindroleid string, bindbit int, value interface{}) (err error) {
	if t.be_delete == true {
...
func (t *Transaction) ReadContextStatus(area, id, contextname string, upordown uint8, bindroleid string, bindbit int, value interface{}) (err error) {
	if t.be_delete == true {
