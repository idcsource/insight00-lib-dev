...
func SendPrefixStat(process *nst.ProgressData, unid, selfname, transactionid string, intransaction bool, roleid string, operate int) (receipt Net_SlaveReceipt_Data, err error) {
